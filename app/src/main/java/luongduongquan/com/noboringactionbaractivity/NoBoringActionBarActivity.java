package luongduongquan.com.noboringactionbaractivity;
...
public class NoBoringActionBarActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Ở đây, khi kéo lên kéo xuống Header, chỉ là đẩy cái header lên trên (vô vùng ko hiển thị ra), rồi kéo header xuống lại thôi.

        // it is animation
        mSmoothInterpolator = new AccelerateDecelerateInterpolator();

        // max height of actionBar
        ...
        // Frame layout chứa header picture và icon hình trái đất
        mHeader = findViewById(R.id.header);


        // Phần header picture, có animation zoom hình
    ...
    private void setupListView() {
        ...
        // Tạo ra 1 cái empty view với chiều cao là 250dp = chiều cao của headerActionBar.
        mPlaceHolderView = getLayoutInflater().inflate(R.layout.view_header_placeholder, mListView, false);

        // Rồi gắn cái View này luôn luôn ở trên cùng của cái ListView để kéo ghịch cái ListView xuống bên dưới HeaderActionBar
